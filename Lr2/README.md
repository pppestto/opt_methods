...
Краткое описание
-----------------
Реализован метод Пиявского для поиска глобального минимума одномерной функции, предполагаемой Липшицевой.
...
3. Инициализируем выборку крайними точками и итеративно добавляем точки по Пиявскому:
...
Визуализация
------------
- Синяя плавная линия — исходная функция f(x).
