...
Краткое описание
-----------------
Реализован симплекс-метод в двух фазах  для решения задач линейного программирования в каноническом виде. Программа:
- читает задачу из текстового файла (формат указан ниже),
- приводит задачи к каноническому виду, добавляя необходимые добавочные переменные ,
